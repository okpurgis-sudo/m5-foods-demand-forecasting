...
| --- | --- | --- | --- | --- |
| bottom | XGBoost_log1p | 0.3982 | 0.7594 | 1.1719 |
| middle | XGBoost_log1p | 0.9364 | 1.4473 | 0.8154 |
| top | XGBoost_log1p | 5.1927 | 8.9086 | 0.3218 |
...
| bottom | XGBoost_poisson | 0.4308 | 0.7361 | 0.3398 | 1.2678 |
| bottom | XGBoost_squarederror_v4 | 0.4319 | 0.7352 | 0.3398 | 1.2708 |
| middle | XGBoost_log1p | 0.9364 | 1.4473 | 1.1484 | 0.8154 |
| middle | XGBoost_poisson | 0.9635 | 1.4021 | 1.1484 | 0.8390 |
| middle | XGBoost_squarederror_v4 | 0.9637 | 1.4034 | 1.1484 | 0.8391 |
| top | XGBoost_log1p | 5.1927 | 8.9086 | 16.1387 | 0.3218 |
| top | XGBoost_squarederror_v4 | 5.3062 | 8.5069 | 16.1387 | 0.3288 |
| top | XGBoost_poisson | 5.3093 | 8.4943 | 16.1387 | 0.3290 |
<!-- FINAL_RESULTS_TABLE_END -->

### 結果の解釈

<!-- RESULT_INTERPRETATION_START -->
- `top`: MAE 5.1927、MAE ratio 0.3218。平均販売数が大きく、販売パターンを比較的学習しやすい。
- `middle`: MAE 0.9364、MAE ratio 0.8154。販売数が小さくなり、相対誤差が拡大した。
- `bottom`: MAE 0.3982、MAE ratio 1.1719。平均販売数が約0.34個でゼロ販売日も多いため、小さな絶対誤差でも比率が大きくなる。
...
| --- | --- | --- | --- | --- | --- |
| bottom | v4_price_event_dept | - | 0.4319 | 0.7352 | 1.2708 |
| middle | v4_price_event_dept | - | 0.9637 | 1.4034 | 0.8391 |
| top | v4_price_event_dept | - | 5.3062 | 8.5069 | 0.3288 |
